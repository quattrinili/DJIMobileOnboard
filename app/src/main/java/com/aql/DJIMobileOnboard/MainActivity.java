package com.aql.DJIMobileOnboard;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mFlightController == null) {
            showToast("Not connected to a flight controller!");
            finish();
        }
        ...
        // Button associated with a message.
    ...
    /**
     * Initialize flight controller, otherwise terminates.
     */
    private void initializeFlightController() {
    ...
    public void sendByte(byte [] data) {
        /// https://developer.dji.com/onboard-sdk/documentation/appendix/mobile-onboard-APIs.html
